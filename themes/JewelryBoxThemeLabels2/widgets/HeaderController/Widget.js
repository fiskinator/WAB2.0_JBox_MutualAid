...
//`dev summit
        ...
        //add some margein to avoid mess layout changed from -5 to -3
...
// JF Make the widget area wider and greater height.  Icon sized adjusted to 30px in CSS of Default Theme Header controller
...
// Modified by JF & lCS: width to 70px....5/20/2015
            width: 70 + 'px',
//width: this.height + 'px',
        ...
        html.create('img', {
          src: iconUrl,
          style: {
// Added by JF & lCS: -3 px....5/20/2015
            marginTop: (((this.height - 24) / 2)-10) + 'px'
